...
const NavBar = () => {
    ...
    overlayMenu = (
      <div class='overlay-menu'>
        <ul id='menu'>
          ...
          <Button
            btnText='LOGIN'
            btnClass='button redButton overlayBtn'></Button>
          <div className='socialLogosCon'>
            <div>
  ...
  return (
    <header>
      <nav id='navbar' className={overlayColor}>
        <div class='nav-wrapper'>
          ...
          <div class='hamburger'>{menuIcon}</div>
          <ul id='menu'>
            <li>
              <a href='#home'>FEATURES</a>
            </li>
            ...
            <Button btnText='LOGIN' btnClass='button redButton'></Button>
          </ul>
        </div>
      </nav>
